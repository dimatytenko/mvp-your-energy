            ...
            <li class="card-item favorite-card-item" id=${s}>
                ...
                <div class="card-info">
                    <div class="card-info-about">
                        ...
                        <div class="card-info-about-value card-time">${t} / ${c} min</div>
                    </div>
                    <div class="card-info-about">
